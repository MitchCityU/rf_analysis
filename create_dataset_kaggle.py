...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--source",
        type=str,
        default="/mnt/c/users/mitch/downloads/ai_classifier/libriiq_dwingeloo/dwingeloo/archive.zip",
    ...
    target_dir = Path("/mnt/c/users/mitch/downloads/ai_classifier/dwingeloo/")
    raw_dir = Path("/mnt/c/users/mitch/downloads/ai_classifier/libriiq_dwingeloo/dwingeloo/raw")
